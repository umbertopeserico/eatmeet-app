 ...
 */
public class OldEventsFragment extends Fragment  implements Notificable {
        ...
        if(EatMeetApp.getFiltersManager().isActiveF_restaurants()){
            ...
            backendStatusManager.setBackendStatusListener(new BackendStatusListener() {
                ...
                public void onSuccess(Object response, Integer code) {
                    Logger.getLogger(OldEventsFragment.this.getClass().getName()).log(Level.INFO, "Connection succeded");
                ...
                public void onFailure(Object response, Integer code) {
                    Logger.getLogger(OldEventsFragment.this.getClass().getName()).log(Level.SEVERE, "Connection NOT succeded");
                }
            });
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_oldevents, container, false);
